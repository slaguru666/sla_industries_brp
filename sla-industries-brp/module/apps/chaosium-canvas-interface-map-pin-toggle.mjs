...
export default class ChaosiumCanvasInterfaceMapPinToggle extends ChaosiumCanvasInterface {
  ...
  async #handleClickEvent () {
    game.socket.emit('system.sla-industries-brp', { type: 'toggleMapNotes', toggle: true })
    ...
    for (const uuid of this.noteUuids) {
      const doc = await fromUuid(uuid)
      if (doc) {
        const texture = (toggle ? 'systems/sla-industries-brp/assets/map-pin.svg' : 'systems/sla-industries-brp/assets/map-pin-dark.svg')
