...
export const characteristicMenuOptions = (actor, token) => [
  ...
  },
  {
    ...
    condition: (el) => (el[0].dataset.characteristic === 'pow' && game.settings.get('sla-industries-brp', 'development') && actor.system.stats.pow.improve),
    callback: (el) => {
...
export const skillstabMenuOptions = (actor, token) => [
  ...
  {
    name: game.i18n.localize("BRP.xpAllGain") + " (" + game.settings.get('sla-industries-brp', 'xpFormula') + ")",
    icon: '<i class="fas fa-dice-d6"></i>',
    condition: () => game.settings.get('sla-industries-brp', 'development'),
    callback: (el) => {
      const itemId = BRPCharDev.onXPGainAll(actor, token, "roll");
    }
  },
  {
    name: game.i18n.localize("BRP.xpAllGain") + " (" + game.settings.get('sla-industries-brp', 'xpFixed') + ")",
...
export const combatMenuOptions = (actor, token) => [
  ...
  },
  {
    ...
    condition: () => !game.settings.get('sla-industries-brp', 'useHPL'),
    callback: (el) => {
...
export const skillMenuOptions = (actor, token) => [
  ...
  {
    name: game.i18n.localize("BRP.xpGain") + " (" + game.settings.get('sla-industries-brp', 'xpFormula') + ")",
    icon: '<i class="fas fa-dice-d6"></i>',
    condition: (el) => (game.settings.get('sla-industries-brp', 'development') && el[0].dataset.xp === 'true'),
    callback: (el) => {
      BRPCharDev.onXPGainSingle(el[0].dataset.itemId, actor, token, "formula", 'false');
    }
  },
  {
    name: game.i18n.localize("BRP.xpGain") + " (" + game.settings.get('sla-industries-brp', 'xpFixed') + ")",
    icon: '<i class="fas fa-dice-three"></i>',
    condition: (el) => (game.settings.get('sla-industries-brp', 'development') && el[0].dataset.xp === 'true'),
    callback: (el) => {
...
export const allegianceMenuOptions = (actor, token) => [
  ...
  {
    name: game.i18n.localize("BRP.improve") + " (" + game.settings.get('sla-industries-brp', 'xpFormula') + ")",
    icon: '<i class="fas fa-dice-d6"></i>',
    condition: (el) => (game.settings.get('sla-industries-brp', 'development') && el[0].dataset.xp === 'true'),
    callback: (el) => {
      BRPCharDev.onXPGainSingle(el[0].dataset.itemId, actor, token, "formula", 'false');
  ...
  {
    name: game.i18n.localize("BRP.improve") + " (" + game.settings.get('sla-industries-brp', 'xpFixed') + ")",
    icon: '<i class="fas fa-dice-three"></i>',
    condition: (el) => (game.settings.get('sla-industries-brp', 'development') && el[0].dataset.xp === 'true'),
    callback: (el) => {
      BRPCharDev.onXPGainSingle(el[0].dataset.itemId, actor, token, "fixed", 'false');
