...
export async function registerSettings() {
  ...
  //Power Menu Button
  game.settings.registerMenu('sla-industries-brp', 'powerRules', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'optionalRules', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'diceOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'combatOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'xpOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'npcOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'charOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'gameMods', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'displayOptions', {
  ...
  game.settings.registerMenu('sla-industries-brp', 'brpidOptions', {
  ...
  game.settings.register('sla-industries-brp', "switchShift", {
  ...
  game.settings.register('sla-industries-brp', "development", {
    name: "",
    hint: "",
    scope: "world",
  ...
  game.settings.register('sla-industries-brp', "beastiary", {
    name: "",
    hint: "",
    scope: "world",
    requiresReload: false,
  ...
  game.settings.register('sla-industries-brp', "gameVersion", {
    name: "",
    hint: "",
    scope: "world",
    requiresReload: false,
  ...
  game.settings.register('sla-industries-brp', "worldSchemaVersion", {
    name: "",
    hint: "",
    scope: "world",
    requiresReload: false,
