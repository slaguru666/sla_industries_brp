...
export class BRPDiceSettings extends FormApplication {
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      id: 'dice-settings',
      template: 'systems/sla-industries-brp/templates/settings/dice-settings.html',
      width: 550,
      height: 'auto',
      closeOnSubmit: true
    })
  ...
  async _updateObject(event, data) {
    for await (const key of Object.keys(SETTINGS)) {
      const nextValue = Object.prototype.hasOwnProperty.call(data, key)
        ? data[key]
        : game.settings.get('sla-industries-brp', key)
      game.settings.set('sla-industries-brp', key, nextValue)
    }
  }
